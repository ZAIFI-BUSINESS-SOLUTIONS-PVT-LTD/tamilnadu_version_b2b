            ...
            <CardHeader className="p-0">
              <motion.div className="flex flex-col items-center text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.06 }}>
                <div className="flex items-center mb-2">
                  <CardTitle className="text-primary-foreground text-lg">Educator Portal</CardTitle>
                </div>
                <CardDescription className="text-primary-foreground/80 text-sm">Sign in to manage your courses and students</CardDescription>
              </motion.div>
            </CardHeader>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="flex justify-end mt-2">
                  <Button type="button" variant="link" onClick={() => navigate('/auth/forgot-password?role=educator')} className="h-auto p-0 text-sm">
                    Forgot password?
                  </Button>
                </div>
              </div>
