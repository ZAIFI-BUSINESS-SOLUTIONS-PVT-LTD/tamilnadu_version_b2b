            ...
            <CardHeader className="p-0">
              <motion.div className="flex flex-col items-center text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.06 }}>
                <div className="flex items-center mb-2">
                  <CardTitle className="text-white text-lg">Student Portal</CardTitle>
                </div>
                <CardDescription className="text-blue-100 text-sm">Sign in to continue your learning journey</CardDescription>
              </motion.div>
            </CardHeader>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="block w-full pl-3 pr-10 py-2.5 border border-slate-100 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm bg-white"
                    required
                  />
                  <motion.button
                    type="button"
