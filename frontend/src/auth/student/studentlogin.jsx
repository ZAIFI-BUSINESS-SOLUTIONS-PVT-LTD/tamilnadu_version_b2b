...
import { ArrowLeft, GraduationCap, Eye, EyeSlash, Sparkle } from '@phosphor-icons/react';
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 p-6 relative">
          ...
          <div className="flex flex-col items-center">
            <div className="flex items-center mb-3">
              <GraduationCap weight="fill" size={24} className="text-white mr-2" />
              <h1 className="text-2xl font-medium text-white">Student Login</h1>
            </div>
            <p className="text-blue-100 text-center text-sm">
              Welcome back, future genius! Let's continue your journey.
            </p>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="block w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                required
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full px-4 pr-10 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm"
                  required
                />
                <motion.button
                  type="button"
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-500">
              Need help? <a href="#" className="text-blue-600 hover:text-blue-500 hover:underline">Contact student support</a>
            </p>
          </div>
        </div>
